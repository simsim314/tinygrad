...
def load(fn:str, gguf_device=None, deterministic_q6_fp16=False, deterministic_f32_fp16=False):
  if fn.endswith('.index.json'):
    ...
    return gguf_load(gguf_tensor,deterministic_q6_fp16=deterministic_q6_fp16,
  ...
  with WallTimeEvent(BenchEvent.LOAD_WEIGHTS):
    if model_path.is_dir():
      ...
      weights = load(str(model_path),gguf_device="CPU" if dfloat or low_memory else None,
                     deterministic_q6_fp16=dfloat,deterministic_f32_fp16=dfloat)
